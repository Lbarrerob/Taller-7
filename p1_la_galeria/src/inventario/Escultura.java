...
public class Escultura extends ObraDeArte
{
	...
	//constructor
	public Escultura(int codigoRegistro, String tipoPieza, String titulo, int anio, String lugar, String autor,
				boolean exhibicion, String estado, int valor, boolean esValorFijo, int propietarioActual, float alto,
				float ancho, float profundidad, String material) 
	{
...
public class Escultura extends ObraDeArte
{
	...
	//constructor
	public Escultura(int codigoRegistro, String tipoPieza, String titulo, int anio, String lugar, Artista autor,
