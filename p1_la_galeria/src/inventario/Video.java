...
public class Video extends ObraDeArte
{
	...
	//constructor
	public Video(int codigoRegistro, String tipoPieza, String titulo, int anio, String lugar, String autor,
				boolean exhibicion, String estado, int valor, boolean esValorFijo, int propietarioActual, 
