...
public class SandboxArreglos
{
    ...
    {
    	int nuevaLongitudEntero = arregloEnteros.length + 1;
        arregloEnteros = Arrays.copyOf(arregloEnteros, nuevaLongitudEntero);
        arregloEnteros[nuevaLongitudEntero - 1] = entero;
    }
    ...
    {
    	int nuevaLongitudCadena = arregloCadenas.length + 1;
        arregloCadenas = Arrays.copyOf(arregloCadenas, nuevaLongitudCadena);
        arregloCadenas[nuevaLongitudCadena - 1] = cadena;
    }
    ...
    public int[] calcularRangoEnteros( )
    {
        ...
        int[] rango = new int[]{minimo, maximo};
        return rango;
    }
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        for (int i = 0; i < arregloEnteros.length - 1; i++) {
            if (arregloEnteros[i] == arregloEnteros[i + 1]) {
                contador++;
                while (i < arregloEnteros.length - 1 && arregloEnteros[i] == arregloEnteros[i + 1]) {
                    i++;
                }
            }
        }
    ...
    public boolean compararArregloEnteros( int[] otroArreglo )
    {
        ...
        // Comparar los elementos de ambos arreglos en direcciones opuestas
        for (int i = 0, j = longitud - 1; i < longitud; i++, j--) {
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
        ...
        for (int i = 0; i < cantidad; i++) {
            int numeroAleatorio = random.nextInt(rango) + minimo;
